        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="bg-white p-8 rounded-3xl shadow-xl border border-slate-100 max-w-sm w-full relative overflow-hidden group hover:shadow-2xl transition-all duration-300">
              ...
              <button className="w-full py-3 bg-gradient-to-r from-[#163e85] to-brand-primary hover:opacity-95 text-white font-medium text-xs rounded-xl shadow-md cursor-pointer transition-all">
                Get Started
              </button>
            </div>
          </motion.div>
          ...
          {/* Right: Content */}
          <motion.div
            className="order-1 lg:order-2 space-y-6 max-w-xl"
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true, amount: 0.2 }}
          ...
          >
            ...
            <p className="text-slate-600 leading-relaxed text-base">
              ...
              We're the bridge that connects job opportunities with 
              the best candidates, with no middleman involved.
            </p>
          </motion.div>
